              ...
              <div className="inline-block w-full max-w-md p-6 my-8 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                ...
                <div className="mt-2">
                  <p className="text-sm text-gray-500 font-medium">
                    Hello! Please Click The Below Button To Make A Payment.
                  </p>
                </div>
                ...
                <div className="w-full mt-4">
                  ...
                  <button
                    type="button"
                    className="mt-2 w-full inline-flex justify-center px-4 py-2 text-sm font-medium text-white-700 rounded-md hover:bg-red-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-red-500"
                    onClick={closeModal}
                  >
                    Cancel Payment
                  </button>
